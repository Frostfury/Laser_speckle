...
vmcmedium.refractive_index(elements_of_the_circle2) = 1.3334;
vmcmedium.refractive_index(elements_of_the_circle) = 1.3332;
figure;
...
options.photon_count= 1e4 ;
options.seed_used= 1614375802 ;
...
hold off
figure;
plot(solution.boundary_exitance(1:100),'DisplayName','solution.boundary_fluence');
